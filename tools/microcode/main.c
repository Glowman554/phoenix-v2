...
int main() {
	...
	microcode[INSTR_JZRI << 3 | MICROCODE_STEP_0] = PUT_IADR_ADDR | SAVE_PCB_IF_EQ;
	microcode[INSTR_JZRI << 3 | MICROCODE_STEP_1] = PC_FLUSH_COND;
	microcode[INSTR_JZRI << 3 | MICROCODE_STEP_2] = FINISH;
